...
from flickr.function.config import config, update_config
from flickr.function.test import test_net
...
def parse_args():
    ...
    parser.add_argument('--hvd', help='whether to use distributed training', default=False, action='store_true')
    ...
    if args.slurm:
        ...
        os.environ['MASTER_PORT'] = str(29250)
