...
DATASET_CATALOGS = {'FlickrITDataset': FlickrITDataset}
...
def make_dataloader(cfg, dataset=None, mode='test', distributed=False, num_replicas=None, rank=None,
    ...
    if dataset is None:
        dataset = build_dataset(dataset_name=cfg.DATASET.DATASET,
                                split=mode,
                                seq_len=cfg.DATASET.SEQ_LEN, min_seq_len=cfg.DATASET.MIN_SEQ_LEN,
                                root_path=cfg.DATASET.ROOT_PATH, transform=transform,
