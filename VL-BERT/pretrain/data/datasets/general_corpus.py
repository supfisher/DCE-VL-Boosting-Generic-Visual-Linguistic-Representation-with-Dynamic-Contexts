...
class GeneralCorpus(Dataset):
    ...
    # def load_corpus(self, token_path='./data/en_corpus/'):
    #     token_path = os.path.join(token_path, "pretrain_tokens.pt")
    ...
    #             token_list.append(self.tokenizer.tokenize(raw_corpu))
    #
    #         token_tensor = torch.stack(token_list)
    #
    #         torch.save(token_tensor, os.path.join(token_path, "pretrain_tokens.pt"))
    #
    #         return token_tensor
    #     else:
