...
class ImgPostivePairs(torch.utils.data.Dataset):
    ...
    def __init__(self, split='train',
        ...
        coeffi_CKPT = torch.load(os.path.join(cache, 'accumulated_scores.pth'))

        dis_abnorm_mean = lambda tensor_list: tensor_list[tensor_list <= 50*tensor_list.mean()].mean().item()
        self.coeffi_left = dis_abnorm_mean(coeffi_CKPT["{}_accumulated_scores_left".format(self.split)])
        self.coeffi_right = dis_abnorm_mean(coeffi_CKPT["{}_accumulated_scores_right".format(self.split)])
        ...
        positive_pairs_cache = os.path.join(cache, '{}_positive_pairs.pkl'.format(self.split))
...
if __name__ == '__main__':
    parser.add_argument("--saved_dir", default='cache/event_similarity_test', type=str,
                        help="saved dir.")
