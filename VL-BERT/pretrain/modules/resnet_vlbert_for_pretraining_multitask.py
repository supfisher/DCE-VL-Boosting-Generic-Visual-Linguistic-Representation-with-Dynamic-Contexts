...
class ResNetVLBERTForPretrainingMultitask(Module):
    ...
    def forward(self,
        ...
        relationship_logits_multi, mlm_logits_multi, mvrc_logits_multi, text_out_multi, object_out_multi, pooled_rep_multi \
                                                                                    = self.vlbert(text_input_ids_multi,
