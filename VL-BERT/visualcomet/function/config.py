...
_C.attention_probs_dropout_prob = 0.1
_C.hidden_act = "gelu"
_C.hidden_dropout_prob = 0.1
_C.hidden_size = 1024
_C.initializer_range = 0.02
_C.intermediate_size = 4096
_C.max_position_embeddings = 512
_C.num_attention_heads = 16
_C.num_hidden_layers = 24
_C.type_vocab_size = 2
_C.vocab_size = 28996
_C.img_label_dim = 1601
_C.img_dim = 2048
_C.batch_imgs = 8
_C.temperature = 1
...
_C.NETWORK.MASK_RAW_PIXELS = False
...
_C.NETWORK.IMAGE_FROZEN_IMAGE_PRETRAINED = False
...
_C.NETWORK.WITH_EVE_LOSS = False
_C.NETWORK.WITH_IOC_LOSS = False
_C.NETWORK.WITH_REL_LOSS = False
_C.NETWORK.WITH_MLM_LOSS = False
_C.NETWORK.WITH_MVRC_LOSS = False
_C.NETWORK.WITH_CONTRASTIVE_LOSS = False
